item_image_help = {
    ...
    'default_dance_style': '''Choose the default dance style.  Note, this should be a
    style connected to the performer (if chosen), or it will cause an error.
    The style can be changed on an image by image basis on the next page.''',
