...
urlpatterns = [
    ...
    url(r'^combination/update/(?P<pk>.*)/$',
        CombinationUpdate.as_view(),
        name='combination-update'),
    ...
    url(r'^position/add/(?P<order>\d+)/(?P<category>\d+)/$',
        ...
        name='position-add'),
    url(r'^position/add/$', PositionCreate.as_view(), name='position-add'),
    ...
    url(r'^subject/update/(?P<pk>.*)/$',
        SubjectUpdate.as_view(),
        name='subject-update'),
    url(r'^subject/view/(?P<pk>.*)/$',
        SubjectView.as_view(),
        name='subject-view'),
    ...
    url(r'^combination/list/?', CombinationList.as_view(), name='combo_list'),
    ...
    url(r'^shastra/update/(?P<pk>.*)/$',
        ...
        name='shastra-update'),
    url(r'^source/add/$', SourceCreate.as_view(), name='source-add'),
    url(r'^source/update/(?P<pk>.*)/$',
        SourceUpdate.as_view(),
        name='source-update'),
    url(r'^image/upload/?', BulkImageUpload.as_view(), name='image_upload'),
]
